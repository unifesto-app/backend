...
AND column_name IN ('slug', 'short_description', 'banner_url', 'thumbnail_url', 
                     'venue', 'city', 'state', 'country', 'event_type', 'category',
                     'tags', 'max_attendees', 'is_free', 'price', 'currency',
