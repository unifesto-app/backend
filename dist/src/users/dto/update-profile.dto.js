...
__decorate([
    ...
    (0, class_validator_1.Matches)(/^[a-z0-9_]{3,50}$/, {
        message: 'Username must be 3-50 characters, lowercase letters, numbers, and underscores only',
    }),
...
__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsIn)(['MALE', 'FEMALE', 'NON_BINARY', 'PREFER_NOT_TO_SAY']),
    __metadata("design:type", String)
