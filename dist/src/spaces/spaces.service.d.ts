...
export declare class SpacesService {
    ...
    getSpaceMembers(spaceId: string, options?: {
        page?: number;
        limit?: number;
        search?: string;
        roleCode?: RoleCode;
    ...
    searchAddableUsers(spaceId: string, search?: string): Promise<{
        users: {
            id: string;
            username: string | null;
            fullName: string | null;
    ...
    addSpaceMember(spaceId: string, actingUserId: string, userId: string, roleCode: RoleCode): Promise<{
        message: string;
        member: {
            role: {
                id: string;
    ...
    updateSpaceMemberRole(spaceId: string, userRoleId: string, actingUserId: string, roleCode: RoleCode): Promise<{
        message: string;
        member: {
            role: {
                id: string;
    ...
    removeSpaceMember(spaceId: string, userRoleId: string, actingUserId: string): Promise<{
        message: string;
    }>;
    private enforceRoleLimits;
