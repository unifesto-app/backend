...
import { CreateSpaceDto, UpdateSpaceDto, UpdateSpaceStatusDto, CreateSpaceStatusRequestDto, ReviewSpaceStatusRequestDto, AddSpaceMemberDto, UpdateSpaceMemberRoleDto } from './dto';
...
export declare class SpacesController {
    ...
    getSpaceMembers(id: string, page?: string, limit?: string, search?: string, role?: RoleCode): Promise<{
        members: ({
            role: {
                id: string;
                code: import("@prisma/client").$Enums.RoleCode;
    ...
    searchAddableUsers(id: string, q?: string): Promise<{
        users: {
            id: string;
            username: string | null;
            fullName: string | null;
    ...
    addSpaceMember(id: string, dto: AddSpaceMemberDto, user: User): Promise<{
        message: string;
        member: {
            role: {
                id: string;
    ...
    updateSpaceMemberRole(id: string, userRoleId: string, dto: UpdateSpaceMemberRoleDto, user: User): Promise<{
        message: string;
        member: {
            role: {
                id: string;
    ...
    removeSpaceMember(id: string, userRoleId: string, user: User): Promise<{
        message: string;
    }>;
